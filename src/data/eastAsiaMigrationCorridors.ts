...
export const EAST_ASIA_MIGRATION_CORRIDORS_BY_ISO = {
  ...
  JPN: [
    ...
    directCorridor({ id: 'thailand-narita-overstay', label: 'Thailand · schematic Japan air-entry-to-overstay pattern', status: 'irregular', originLabel: 'Thailand (schematic departure)', originCode: 'THA', origin: C.bangkok, destinationLabel: 'Japan air-entry / overstay pattern', destinationType: 'airport entry', destination: C.tokyoNarita, mode: 'air', sources: [JAPAN_IRREGULAR_STAY] }),
  ],
  KOR: [
