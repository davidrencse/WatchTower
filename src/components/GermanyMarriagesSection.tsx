...
const MARRIAGE_RATES_SERIES: readonly MarriageRatesRow[] = [
  ...
  { year: '2001', totalMarriages: 389591, crudeMarriageRate: 4.7, avgAgeMen: 31.5, avgAgeWomen: 28.7 },
  { year: '2002', totalMarriages: 391963, crudeMarriageRate: 4.7, avgAgeMen: 31.7, avgAgeWomen: 28.9 },
  { year: '2003', totalMarriages: 382911, crudeMarriageRate: 4.6, avgAgeMen: 31.9, avgAgeWomen: 29.1 },
  { year: '2004', totalMarriages: 395992, crudeMarriageRate: 4.8, avgAgeMen: 32.1, avgAgeWomen: 29.3 },
  { year: '2005', totalMarriages: 388451, crudeMarriageRate: 4.7, avgAgeMen: 32.3, avgAgeWomen: 29.5 },
  { year: '2006', totalMarriages: 373681, crudeMarriageRate: 4.5, avgAgeMen: 32.5, avgAgeWomen: 29.7 },
  { year: '2007', totalMarriages: 368922, crudeMarriageRate: 4.5, avgAgeMen: 32.7, avgAgeWomen: 29.9 },
  { year: '2008', totalMarriages: 377055, crudeMarriageRate: 4.6, avgAgeMen: 32.9, avgAgeWomen: 30.1 },
  { year: '2009', totalMarriages: 378439, crudeMarriageRate: 4.6, avgAgeMen: 33.1, avgAgeWomen: 30.3 },
  { year: '2010', totalMarriages: 382047, crudeMarriageRate: 4.7, avgAgeMen: 33.3, avgAgeWomen: 30.5 },
  { year: '2011', totalMarriages: 377816, crudeMarriageRate: 4.6, avgAgeMen: 33.5, avgAgeWomen: 30.7 },
  { year: '2012', totalMarriages: 387423, crudeMarriageRate: 4.8, avgAgeMen: 33.7, avgAgeWomen: 30.9 },
  { year: '2013', totalMarriages: 373655, crudeMarriageRate: 4.6, avgAgeMen: 33.9, avgAgeWomen: 31.1 },
  { year: '2014', totalMarriages: 385952, crudeMarriageRate: 4.7, avgAgeMen: 34.1, avgAgeWomen: 31.3 },
  { year: '2015', totalMarriages: 400115, crudeMarriageRate: 4.9, avgAgeMen: 34.3, avgAgeWomen: 31.5 },
  { year: '2016', totalMarriages: 410426, crudeMarriageRate: 5.0, avgAgeMen: 34.5, avgAgeWomen: 31.7 },
  { year: '2017', totalMarriages: 407466, crudeMarriageRate: 4.9, avgAgeMen: 34.6, avgAgeWomen: 31.8 },
  { year: '2018', totalMarriages: 449466, crudeMarriageRate: 5.4, avgAgeMen: 34.7, avgAgeWomen: 31.9 },
  { year: '2019', totalMarriages: 416324, crudeMarriageRate: 5.0, avgAgeMen: 34.8, avgAgeWomen: 32.0 },
  { year: '2020', totalMarriages: 373304, crudeMarriageRate: 4.5, avgAgeMen: 34.9, avgAgeWomen: 32.1 },
  { year: '2021', totalMarriages: 357785, crudeMarriageRate: 4.3, avgAgeMen: 35.0, avgAgeWomen: 32.2 },
  { year: '2022', totalMarriages: 390743, crudeMarriageRate: 4.7, avgAgeMen: 35.1, avgAgeWomen: 32.3 },
  { year: '2023', totalMarriages: 360979, crudeMarriageRate: 4.3, avgAgeMen: 35.2, avgAgeWomen: 32.5 },
  { year: '2024', totalMarriages: 349200, crudeMarriageRate: 4.2, avgAgeMen: 35.3, avgAgeWomen: 32.7 },
  { year: '2025', totalMarriages: 348700, crudeMarriageRate: 4.2, avgAgeMen: 35.4, avgAgeWomen: 32.9 },
];

const MARRIAGE_RATES_COMPOSED_CONFIG = {
  totalMarriages: { label: 'Total marriages', color: '#60a5fa' },
  crudeMarriageRate: { label: 'Crude marriage rate (per 1,000 inhabitants)', color: '#f59e0b' },
} satisfies ChartConfig;

const MARRIAGE_RATES_AGE_CONFIG = {
  avgAgeMen: { label: 'Avg age at marriage — men', color: '#22c55e' },
  avgAgeWomen: { label: 'Avg age at marriage — women', color: '#f97316' },
} satisfies ChartConfig;
...
function MarriageRatesVolumeCrudeCard() {
  return (
    <Card className="col-span-full overflow-hidden border-line bg-surface-metric shadow-card">
      <CardHeader className="space-y-1 p-3 pb-2">
        <CardTitle className="text-sm font-semibold text-neutral-100 uppercase tracking-[0.05em]">Total marriages and crude rate</CardTitle>
        <CardDescription className="text-[10px] uppercase tracking-[0.03em] text-neutral-500">
          Annual counts (bars) vs crude marriage rate per 1,000 inhabitants (line)
        </CardDescription>
      </CardHeader>
      <CardContent className="p-3 pt-0">
                ...
                content={
                  <ChartTooltipContent
                    ...
                    formatter={(value) => {
                      ...
                      return `${n.toFixed(1)} / 1,000`;
                    }}
                  />
                }
              />
              <Legend wrapperStyle={{ fontSize: '11px', color: 'rgba(212,212,212,0.9)' }} />
              <Bar yAxisId="left" dataKey="totalMarriages" name="Total marriages" fill="#60a5fa" radius={[2, 2, 0, 0]} isAnimationActive={false} />
              <Line
                yAxisId="right"
                type="monotone"
                dataKey="crudeMarriageRate"
                name="Crude marriage rate (per 1,000)"
                stroke="#f59e0b"
                strokeWidth={2.2}
                dot={false}
...
function MarriageRatesAgeLineCard() {
  return (
    <Card className="col-span-full overflow-hidden border-line bg-surface-metric shadow-card">
      <CardHeader className="space-y-1 p-3 pb-2">
        <CardTitle className="text-sm font-semibold text-neutral-100 uppercase tracking-[0.05em]">Average age at marriage</CardTitle>
        <CardDescription className="text-[10px] uppercase tracking-[0.03em] text-neutral-500">Mean age in years (2000–2025)</CardDescription>
      </CardHeader>
      <CardContent className="p-3 pt-0">
        <ChartContainer config={MARRIAGE_RATES_AGE_CONFIG} className="h-[280px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={[...MARRIAGE_RATES_SERIES]} margin={{ top: 8, right: 10, left: 4, bottom: 8 }}>
              ...
              />
              <Legend wrapperStyle={{ fontSize: '11px', color: 'rgba(212,212,212,0.9)' }} iconType="line" />
              <Line type="monotone" dataKey="avgAgeMen" name="Men" stroke="#22c55e" strokeWidth={2.2} dot={false} isAnimationActive={false} />
              <Line type="monotone" dataKey="avgAgeWomen" name="Women" stroke="#f97316" strokeWidth={2} dot={false} isAnimationActive={false} />
            </LineChart>
          </ResponsiveContainer>
        </ChartContainer>
      </CardContent>
...
export const GERMANY_MARRIAGES_GROUP_COUNT = 16;
...
export const GermanyMarriagesSection = memo(function GermanyMarriagesSection() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <CollapsibleFlagSection title="Marriage rates" count={7} defaultOpen>
        <div className="flex flex-col gap-3">
