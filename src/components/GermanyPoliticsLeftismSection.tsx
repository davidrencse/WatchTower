      ...
      <div className={GOV_POLITICS_CARD_GRID}>
        <Card>
          ...
          <CardContent className="p-3 pt-0">
            <p className="font-mono text-2xl font-semibold text-white">25%</p>
            <p className={`mt-2 font-mono text-[10px] leading-relaxed text-neutral-500 ${UC_META}`}>18-29 year olds</p>
            <a
              href="https://www.bundeswahlleiterin.de/en/bundestagswahlen/2025.html"
              target="_blank"
              rel="noopener noreferrer"
              className={`mt-2 block font-mono text-[10px] text-[var(--uk-accent)] hover:text-neutral-200 ${UC_META}`}
            >
        ...
        <Card>
          ...
          <CardContent className="p-3 pt-0">
            <p className="font-mono text-2xl font-semibold text-white">90%</p>
        ...
        <Card>
          ...
          <CardContent className="p-3 pt-0">
            <p className="font-mono text-2xl font-semibold text-white">39%</p>
            <p className={`mt-2 font-mono text-[10px] leading-relaxed text-neutral-500 ${UC_META}`}>
              Reserved for DEI
            </p>
        ...
        <Card>
          ...
          <CardContent className="p-3 pt-0">
            <p className="font-mono text-2xl font-semibold text-white">90% (46% nationally)</p>
        ...
        <Card>
          ...
          <CardContent className="p-3 pt-0">
            <p className="font-mono text-2xl font-semibold text-white">&gt;27% (3% nationally)</p>
            <div className="mt-2 space-y-0.5">
              <a
                href="https://ilcuk.org.uk/german-election-results-2025/"
                target="_blank"
