...
import { FRANCE_ZIONISM_GROUPS, FRANCE_ZIONISM_METRICS } from '../../../lib/countries/france/francePoliticsZionism';
...
export const GermanyPoliticsZionismSection = memo(function GermanyPoliticsZionismSection({
  ...
  if (isItaly) {
    return (
      <div className="flex flex-col gap-3">
        <aside
          aria-label="Italy Zionism evidence status"
          className="border-l-2 border-amber-400/70 bg-amber-400/[0.06] px-4 py-3 font-sans text-xs leading-relaxed text-amber-100"
        >
          <span className="font-semibold uppercase tracking-[0.08em] text-amber-300">
            Evidence status
          </span>
          <span className="ml-2">{ITALY_ZIONISM_EVIDENCE_NOTE}</span>
        </aside>
        <div className={GOV_POLITICS_CARD_GRID}>
          <GermanyJewishGovernmentCarousel
            entriesOverride={ITALY_JEWISH_GOVERNMENT_PEOPLE}
            sourceCaption="Curated dataset: src/data/countries/italy/italyJewishGovernmentPeople.ts - Source: user-supplied Italy list"
          />
      ...
      <div className="flex flex-col gap-3">
        <div className={GOV_POLITICS_CARD_GRID}>
          <GermanyJewishGovernmentCarousel
            ...
            sourceCaption="Curated dataset: src/data/countries/france/franceJewishGovernmentPeople.ts - Source: attached pasted-text.txt"
          />
          ...
          <Card className="sm:col-span-2 lg:col-span-3 border-blue-500/20 bg-neutral-950/60">
            <CardHeader className="space-y-1 p-3 pb-2">
              ...
              <CardDescription className={`text-[11px] text-neutral-500 ${UC_META}`}>
            ...
            <CardContent className="p-3 pt-0">
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  <div
                    key={item}
                    className="rounded-md border border-white/[0.06] bg-white/[0.02] p-2 font-sans text-[11px] leading-relaxed text-neutral-300"
                  >
                    {item}
                  </div>
                ))}
          ...
          <CardContent className="space-y-2 p-3 pt-0">
            <div className="overflow-x-auto rounded border border-line">
              <table className="w-full min-w-[280px] border-collapse font-sans text-[11px]">
                <thead>
                  <tr className="border-b border-white/[0.06] bg-white/[0.03] text-left text-[11px] uppercase tracking-[0.1em] text-neutral-500">
            ...
            <p className={`font-sans text-[11px] text-neutral-500 ${UC_META}`}>
