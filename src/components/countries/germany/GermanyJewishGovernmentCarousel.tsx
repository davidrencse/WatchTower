...
} from '../../../data/countries/germany/germanyJewishGovernmentPeople';
import { mergeCuratedAndLegacyJewishGovernment, parseGermanyJewishGovernmentCsv } from '../../../lib/countries/germany/germanyJewishGovernment';
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="shrink-0 border-t border-white/[0.08] px-1 pt-3">
              <p className={`font-sans text-[10px] text-neutral-600 ${UC_META}`}>
                {sourceCaption ?? (
                  <>
                    Curated dataset: <code className="text-neutral-500">src/data/countries/germany/germanyJewishGovernmentPeople.ts</code> ·
