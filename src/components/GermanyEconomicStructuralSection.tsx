...
const GERMANY_INDICATORS: readonly EconomicStructuralIndicator[] = [
  {
    id: 'public-debt-gdp',
...
export const GermanyEconomicStructuralSection = memo(function GermanyEconomicStructuralSection() {
  ...
  return (
    <>
      ...
      <EconomicStructuralSection
        indicators={GERMANY_INDICATORS}
        oilSuppliersButton
        onOilSuppliersClick={() => setOilWidgetOpen(true)}
      />
    </>
  );
});
