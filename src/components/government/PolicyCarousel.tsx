...
/**
 * Government → Policies carousel.
 *
 * Presentation extracted from the original Germany-only carousel so France (and
 * any later country) renders the identical card, drag and pagination behaviour
 * from its own sector data.
 */
...
export function PolicyCarousel({ cards, label }: Props) {
